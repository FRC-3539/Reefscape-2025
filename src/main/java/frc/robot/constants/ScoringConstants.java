...
public class ScoringConstants extends BBConstants {
	...
	public static double rotatekP = 125.0;
	...
	public static double rotateMotorToEncoder = 162.0;
	public static double rotateSoftMin = -0.38;
	public static double rotateSoftMax = 0.25;
	public static double rotateOffset = -0.161621;
	...
	public static double algaeLowPosition = 50.0;
