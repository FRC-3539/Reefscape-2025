...
public class AlignConstants {
    ...
    private static final double LOLLIPOP_ALIGN_DISTANCE = 23;
    ...
    public static Pose2d getLollipopAlignPoint(AlignPoint mode, Pose2d robotPose) {
        ...
        if (mode == AlignPoint.LOLLIPOP1) {
            if (robotPose.getX() < 8.78) {
                ...
                targetLollipop = new Translation2d(16.329, 5.8557);
            }
            ...
            if (robotPose.getX() < 8.78) {
                ...
                targetLollipop = new Translation2d(16.329, 4.0269);
            }
            ...
            if (robotPose.getX() < 8.78) {
                ...
                targetLollipop = new Translation2d(16.329, 2.1981);
            }
        ...
        return new Pose2d(
                targetLollipop.getX() + (LOLLIPOP_ALIGN_DISTANCE * INCHES_TO_METERS / distanceToLollipop)
                        * (robotPose.getX() - targetLollipop.getX()),
                targetLollipop.getY() + (LOLLIPOP_ALIGN_DISTANCE * INCHES_TO_METERS / distanceToLollipop)
                        * (robotPose.getY() - targetLollipop.getY()),
